        ...
        <CardContent className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Input
              ...
              onClear={() => setShowPassword(!showPassword)}
              disabled={isLoading}
            />
          ...
          <div className="flex flex-col gap-2">
            ...
            <Input
              ...
              onClear={() => setShowConfirmPassword(!showConfirmPassword)}
              disabled={isLoading}
            />
        ...
        <CardFooter className="flex flex-col gap-4">
          ...
          <div className="text-center">
            <p className="text-sm text-muted-foreground">
              ...
              <Link href="/login" className="text-foreground decoration-0 no-underline font-normal">
                Sign In
              </Link>
            </p>
          </div>
